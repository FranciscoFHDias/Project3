  ...
  it('should return the correct data types', done => {
    api.get(`/api/locations/${location._id}`)
      .end((err, res) => {
        ...
        expect(res.body.addres).to.be.a('string')
        expect(res.body.cost).to.be.an('number')
        expect(res.body.actType).to.be.a('array')
        expect(res.body.dateNum).to.be.a('array')
        expect(res.body.image).to.be.a('string')
        expect(res.body.contactNumber).to.be.an('number')
